...
export const DEFAULT_INPUTS: ProjectInputs = {
  ...
  tariff_per_kwh: 2.20,
  start_fee_per_session: 3,
  // avg_monthly_kwh é calculado automaticamente: n_chargers × power_kw × horas/dia × 30
  // Com padrões (1 × 60 kW × 10 h/dia): 18.000 kWh/mês
  avg_monthly_kwh: 18000,
  monthly_growth_pct: 2,
  initial_occupancy_pct: 20,
  target_occupancy_12m_pct: 40,
  sessions_per_day: 12,
  ...
  corrective_maintenance: 50,
  rent: 0,
  insurance: 0,
  payment_gateway_pct: 8.0,
